...
public class TutorialEvents {
    public static void generateEvents(){
        ...
        ISP.TutEvents.add(new Event(new int [] {0, 1}, new int [] {-20, 5}, new int [] {0, 1}, new int [] {-20, 5}, "Vegetables are getting expensive... will you continue buying them?", "Nah... my diet can take a small hit.", "Yes, my health is important.",148, 1));
